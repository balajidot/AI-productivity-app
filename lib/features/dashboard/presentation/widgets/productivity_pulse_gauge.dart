...
class ProductivityPulseGauge extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProductivityPulseGauge> createState() => _ProductivityPulseGaugeState();
}

class _ProductivityPulseGaugeState extends ConsumerState<ProductivityPulseGauge>
...
class _GaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw a subtle shadow for the progress head (optional, but keeping it clean)
    // No redundant glow for M3 "Google Apps" style
